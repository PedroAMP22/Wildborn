...
export default class Screen1_8 extends ScreenBase {
    ...
    create() {
        ...
        this.infoImage = this.add.image(400, 400, 'moleInfo').setScale(1.4);
        this.infoImage.setVisible(false);
        this.infoImage.setDepth(100);
    }

    createCScreen(){
        this.scene.start('screenLevelSel',{point:"A",transformation:this.player.stateMachine.state.toString(),unlockedTranformations:this.unlockedTranformations});
    }
    createBScreen(){
