...
export default class Screen1_2 extends ScreenBase  {
    ...
    create() {
        ...
        this.movingBlock = new MovingBlock(this,6,this.pointA1,this.pointA2,48,32,false, "mossyBlock3x2")  
    ...
    createBScreen(){
        this.scene.start('screen1_3',{point:"A",transformation:this.player.stateMachine.state.toString(),broken:false,unlockedTranformations:this.unlockedTranformations});
    }
