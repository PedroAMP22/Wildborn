...
export default class Screen2_6 extends ScreenBase {
    ...
    create() {
        ...
        this.moveableBlock = new MoveableBlock(this,5,this.posA1,this.posA2,this.posA3,48,32,true, "icyBlock3x2",this.posA2);           
        ...
        this.moveableBlock2 = new MoveableBlock(this,4,this.posB1,this.posB2,null,48,32,false, "icyBlock3x2",this.posB1);           
        ...
        this.moveableBlock3 = new MoveableBlock(this,4,this.posC1,this.posC2,null,48,32,false, "icyBlock3x2",this.posC1);           
        ...
        this.moveableBlock5 = new MoveableBlock(this,4,this.posE1,this.posE2,null,48,32,false, "icyBlock3x2",this.posE1);           
    ...
    createAScreen(){
        this.scene.start('screen2_5',{point:"B",transformation:this.player.stateMachine.state.toString(),unlockedTranformations:this.unlockedTranformations});
    }
    createBScreen(){
        this.scene.start('screen2_7',{point:"A",transformation:this.player.stateMachine.state.toString(),unlockedTranformations:this.unlockedTranformations});
    }
}
