...
export default class Screen1_1 extends ScreenBase {
    ...
    create() {
        ...
        this.movingBlock = new MovingBlock(this,5,this.pointA1,this.pointA2)  
        this.movingBlock2 = new MovingBlock(this,5,this.pointB1,this.pointB2)     
    ...
    createNextScene(){
        this.scene.start('screen1_2',{point:"A"});
    }
